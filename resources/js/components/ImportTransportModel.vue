<template>
    ...
    <div class="modal fade" id="transport-import-modal" data-backdrop="static">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Import Transport</h4>
...
export default{
  ...
  methods:{
    useToastr,
    async import_file(){
        let data = new FormData($('#transportForm')[0]);
        await this.axios.post(this.apiTransport +'/import_transports', data).then(res =>{
              this.useToastr().success('Transports Added Successfully');
              this.$emit('importTransportSuccess', true);
      }).catch((error)=>{
