<template>
    ...
    <div class="modal fade" id="asset-import-modal" data-backdrop="static">
...
export default{
  ...
  methods:{
    useToastr,
    async import_file(){
        let data = new FormData($('#assetForm')[0]);
        await this.axios.post(this.apiAsset +'/import_assets', data).then(res =>{
              this.useToastr().success('Assets Added Successfully');
