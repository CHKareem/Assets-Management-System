<template>
    ...
    <div class="modal fade" id="lostStolen-import-modal" data-backdrop="static">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Import Lost & Stolen</h4>
...
export default{
  ...
  methods:{
    useToastr,
    async import_file(){
        let data = new FormData($('#lostStolenForm')[0]);
        await this.axios.post(this.apiLostStolen +'/import_lostStolens', data).then(res =>{
              this.useToastr().success('Losts & Stolens Added Successfully');
              this.$emit('importLostStolenSuccess', true);
      }).catch((error)=>{
